...
const EH_I18N = {
  en: {
    ...
    wideLayoutHint:"For the desktop view, use a Sections dashboard and expand this card to the full section width."
  },
  fr: {
    ...
    wideLayoutHint:"Pour l’affichage PC, utilisez une vue Sections et agrandissez cette carte sur toute la largeur de la section."
  },
  nl: {
    ...
    wideLayoutHint:"Gebruik voor de desktopweergave een Secties-dashboard en maak deze kaart even breed als de volledige sectie."
  }
};
...
class EnergyHorizonCard extends HTMLElement {
  ...
  render() {
    ...
    this.shadowRoot.innerHTML=`<style>:host{display:block;container-type:inline-size}ha-card{padding:10px 14px 16px;border-radius:18px}.nav{display:grid;grid-template-columns:42px minmax(190px,390px) 42px;align-items:center;justify-content:center;gap:10px;margin:4px 0 10px}.nav button{border:0;background:transparent;color:#1686c0;padding:10px;border-radius:19px;cursor:pointer;font-size:22px}.date{display:flex;align-items:center;justify-content:center;gap:9px;font-size:18px;font-weight:600;border:1px solid var(--primary-text-color)!important;border-radius:5px!important;padding:10px 14px!important;background:transparent!important;color:var(--primary-text-color)!important}.date ha-icon{width:20px;height:20px}.notice{color:var(--secondary-text-color);font-size:11px;margin-top:8px}.layout-hint{display:none;align-items:center;justify-content:center;gap:8px;margin:10px 12px 0;padding:9px 12px;border-radius:10px;background:color-mix(in srgb,var(--primary-color) 12%,transparent);color:var(--secondary-text-color);font-size:12px;text-align:center}.layout-hint ha-icon{color:var(--primary-color);width:18px;flex:0 0 auto}.desktop-grid,.chart-panel,.summary-panel{display:contents}svg{display:block;width:100%;min-height:360px;touch-action:none}.empty{padding:80px 20px;text-align:center}.readout{display:grid;grid-template-columns:auto repeat(6,minmax(0,1fr));gap:8px;padding:7px 10px;background:var(--secondary-background-color);align-items:center;box-shadow:0 2px 5px #0003}.readout.summary{grid-template-columns:auto repeat(2,minmax(0,1fr))}.readout>b{font-size:12px;color:var(--secondary-text-color)}.readout span{font-size:14px;font-weight:600;white-space:nowrap}.readout small{display:block;color:var(--secondary-text-color);font-size:10px;font-weight:400;white-space:normal}.battery-forecast{display:flex;align-items:center;justify-content:center;gap:9px;margin:4px 12px 8px;padding:8px 10px;border-block:1px solid var(--divider-color);color:var(--secondary-text-color);font-size:13px;text-align:center}.battery-forecast ha-icon{color:#69a400;width:20px;flex:0 0 auto}.battery-forecast b{color:var(--primary-text-color)}.battery-forecast small{display:block;font-size:10px}.rings{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:16px;margin:20px auto 8px;max-width:620px}.performance{text-align:center;min-width:0}.ring{--value:0;--color:#4bb49f;width:180px;height:180px;margin:auto;border-radius:50%;background:conic-gradient(var(--color) calc(var(--value)*1%),var(--divider-color) 0);display:grid;place-items:center}.ring>div{width:154px;height:154px;border-radius:50%;background:var(--card-background-color);display:flex;align-items:center;justify-content:center;flex-wrap:wrap;align-content:center;font-size:15px}.ring b{font-size:28px;color:var(--color)}.ring small{display:block;width:100%;color:var(--secondary-text-color);font-size:15px}.split{display:grid;gap:7px;text-align:left;margin:12px auto;max-width:190px;cursor:pointer}.split i{display:inline-block;width:10px;height:10px;border-radius:50%;background:var(--divider-color);margin-right:7px}.picker{display:none;position:fixed;inset:0;background:#0008;z-index:99;align-items:center;justify-content:center}.picker.open{display:flex}.picker-box{background:var(--card-background-color);padding:0 0 18px;border-radius:10px;min-width:310px;max-width:90vw;box-shadow:0 8px 40px #0007;overflow:hidden}.picker-tabs{display:grid;grid-template-columns:repeat(3,1fr);border-bottom:1px solid var(--divider-color)}.picker-tabs button{border:0;border-bottom:4px solid transparent;background:transparent;color:var(--secondary-text-color);padding:14px 8px;font-size:17px}.picker-tabs .on{color:#1686c0;border-bottom-color:#1686c0}@media(min-width:900px){.layout-hint{display:flex}}@container (min-width:800px){.layout-hint{display:none}ha-card{padding:14px 20px 16px}.nav{grid-template-columns:48px minmax(300px,460px) 48px;margin-bottom:12px}.date{font-size:20px}.desktop-grid{display:grid;grid-template-columns:minmax(0,1fr) minmax(330px,380px);gap:22px;align-items:stretch}.chart-panel,.summary-panel{display:block;min-width:0}.summary-panel{display:flex;flex-direction:column;justify-content:center;border-left:1px solid var(--divider-color);padding-left:20px}.readout{padding:9px 14px;gap:12px}.readout>b{font-size:13px}.readout span{font-size:15px}.readout small{font-size:10px}svg{min-height:430px;max-height:510px}.battery-forecast{font-size:14px;margin:0 0 14px;padding:11px 8px}.battery-forecast ha-icon{width:25px;height:25px}.battery-forecast small{font-size:11px;margin-top:3px}.rings{width:100%;max-width:370px;gap:12px;margin:4px auto 0}.ring{width:150px;height:150px}.ring>div{width:128px;height:128px;font-size:12px}.ring b{font-size:25px}.ring small{font-size:12px}.split{max-width:170px;font-size:12px;margin-top:10px}.notice{text-align:center;margin-top:12px}}@media(max-width:600px){ha-card{padding:8px 0 14px}.nav{margin:0 10px 7px}.readout{grid-template-columns:repeat(3,minmax(0,1fr));gap:4px;padding:7px 6px}.readout>b{grid-column:1/-1}.readout span{font-size:12px}.readout small{font-size:9px}svg{min-height:360px}.rings{gap:8px;margin-top:16px}.ring{width:136px;height:136px}.ring>div{width:116px;height:116px;font-size:11px}.ring b{font-size:22px}.ring small{font-size:12px}.split{font-size:11px;max-width:145px}}</style><ha-card><div class="nav"><button id="previous">‹</button><button class="date" id="date-button"><ha-icon icon="mdi:calendar-month"></ha-icon><span>${this.formattedAnchor()}</span></button><button id="next">›</button></div>${this.historyLoading&&!this.samples?.length?`<div class="empty">${this.t.loading}</div>`:`<div class="desktop-grid"><div class="chart-panel"><div id="readout">${this.detailReadout()}</div>${this.chart()}</div><div class="summary-panel"><div class="battery-forecast"><ha-icon icon="${forecast.icon}"></ha-icon><span><b>${forecast.text}</b><small>${forecast.sub}</small></span></div>${this.performanceRings()}<div class="layout-hint"><ha-icon icon="mdi:view-dashboard-outline"></ha-icon><span>${this.t.wideLayoutHint}</span></div><div class="notice">Energy Horizon · ${this.period==='day'?'1 min':this.period} · Home Assistant Recorder</div></div></div>`}<div class="picker" id="picker"><div class="picker-box"></div></div></ha-card>`;
